...
class html_dom_node
{
   ...
   *
   * Adds itself to the list of DOM Nodes {@see the_html_dom::$nodes}
   */
   ...
   * {@see html_dom_node::parse_selector()}
   *
...
class the_html_dom
{
   ...
   * string length of ({@see the_html_dom::$doc}).
   *
   ...
   * Current character
   *
   * Holds the current character at position {@see the_html_dom::$pos} in
   * the document {@see the_html_dom::$doc}
   *
   ...
   *
   * Noise is stored to {@see the_html_dom::$noise}
   *
   ...
   *
   * Noise is restored from {@see the_html_dom::$noise}
   *
