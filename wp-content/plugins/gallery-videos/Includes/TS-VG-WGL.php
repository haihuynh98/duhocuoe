      ...
      if(jQuery('.GRWR<?php echo $Total_Soft_Gallery_Video; ?>').width() <= 450) {
        ...
        jQuery('.GRWR<?php echo $Total_Soft_Gallery_Video; ?>').each(function(index, elem) {
          if(jQuery(elem).width()=="0") {
            ...
            jQuery(elem).find('#GRU<?php echo $Total_Soft_Gallery_Video; ?>').css({'width': jQuery(elem).find('.imgLiii').not('.noshow1').not('.grid<?php echo $Total_Soft_Gallery_Video; ?>-sizer').length * jQuery(elem).find('.imgLiii').not('.noshow1').not('.grid<?php echo $Total_Soft_Gallery_Video; ?>-sizer').width() + 'px'});
          }
    ...
    (function($) {
      ...
      $.fn.prettyPhoto=function(pp_settings) {
        ...
        $.prettyPhoto.open=function(event) {
          ...
          var tt=$pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.currentTextHolder').text((set_position + 1) + settings.counter_separator_label + $(pp_images).length);
...
<script>
      jQuery(document).on('ready',function() {
        ...
        console.log(array_images<?php echo $Total_Soft_Gallery_Video;?>)
        var y_images<?php echo $Total_Soft_Gallery_Video;?>=0;
        ...
        function imH() {
          ...
          if(jQuery('.ulContWidth').outerWidth() <= 200) {
        ...
        function checkWidth() {
          ...
          jQuery(items).each(function(index, elem) {
            jQuery(elem).css({
              'height': min_height + 'px', 'width': '<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01;?>' + 'px'
            });
          ...
          jQuery('.TotalSoft_GV_LVG_Li').css({'width': <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01;?>+'px'})
        }
          checkWidth();
        checkWidth();
